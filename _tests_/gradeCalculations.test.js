...
describe('grade calculations', () => {
    ...
    test('it should return exam passed status', () => {
        const listValueOfExams = [80, 100, 100, 80]
        expect(isStudentPassExam(listValueOfExams, "Nurkholiq Agani Hafid")).toEqual(true)
    })

    test('it should return exam failed status', () => {
        const listValueOfExams = [50, 40, 70, 80]
        expect(isStudentPassExam(listValueOfExams, "Nurkholiq Agani Hafid")).toEqual(false)
    })
